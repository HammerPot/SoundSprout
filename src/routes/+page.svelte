...
<div style="padding-top: var(--spacing-2); padding-bottom: var(--spacing-2);">
		...
		<div class="card" style="background-color: var(--color-background-3);">
			<h2 class="text-center eyebrow"> What is SoundSprout? </h2>
		...
		<div class="card" style="background-color: var(--color-background-3);">
			...
			<div class="grid min-w-0 grid-cols-1 gap-4 md:grid-cols-3">
				...
				<div class="card interactive" style="">
					...
					<p class="text-center" style="color: var(--color-accent-text)"> Submit your website to the SoundSprout YSWS! </p>
				</div>
				<div class="card interactive" style="">
