	...
	<div class="info-card-grid__cell" style="padding-top: var(--spacing-2); padding-bottom: var(--spacing-2);">
		<div class="container">
			<div class="card" style="background-color: var(--color-background-3);">
				...
				<p style="color: var(--color-text);">A great resource you may find useful are the <a href="https://developer.mozilla.org/en-US/docs/Web/API/Web_Audio_API">MDN Web Docs</a>, where you can find in-depth explanations of the APIs and useful libraries that can be used to achieve your goal.</p>
			</div>
		</div>
	</div>
			...
			<!-- <div style="padding-top: var(--spacing-1); padding-bottom: var(--spacing-2);">
				...
				<div style="padding-top: var(--spacing-1); padding-bottom: var(--spacing-2);">
					<details class="card" style="">
						...
						<p class="" style="color: var()"> To prove you have spent at least 6 hours working on your website you must use <a href="https://hackatime.hackclub.com/" style="color: var(--color-neutral)">Hackatime</a> and make periodic commits via Git while working on your website. </p>
					</details>
				</div>
				<div style="padding-top: var(--spacing-1); padding-bottom: var(--spacing-2);">
					<details class="card" style="background-color: var();">
